...
public class StudentController {
     ...
     * @param curPage  当前页，即实际中的页，到时候真正分页查询传参要-1，用下标
     * @param response
     * @return
     */
    ...
    public Page<Student> findByPage(Integer curPage, HttpServletResponse response){
        ...
        //curPage是当前页，即实际中的页，到时候真正分页查询传参要-1，用下标 ; pageSize是每页的大小，即每页显示的记录数
    ...
    @ResponseBody
    public Page<Student> findByPage1(Integer curPage, Integer pageSize, HttpServletResponse response){
        //解决跨域请求
        response.setHeader("Access-Control-Allow-Origin", "*");
        if (curPage == null || curPage <= 0){
            curPage = 0;
        ...
        return studentService.findByPage(curPage, pageSize);
    }
     ...
     * @return
     */
    @RequestMapping("/findByPageAndSort")
    @ResponseBody
    public Page<Student> findByPageAndSort(Integer curPage, Integer pageSize, HttpServletResponse response){
        //解决跨域请求
        response.setHeader("Access-Control-Allow-Origin", "*");
        if (curPage == null || curPage <= 0){
            curPage = 0;
        ...
        return studentService.findByPageAndSort(curPage, pageSize);
    }
     ...
     * @return
     */
    @RequestMapping("/findByPageAndSort1")
    @ResponseBody
    public Page<Student> findByPageAndSort1(Integer curPage, Integer pageSize, HttpServletResponse response){
        //解决跨域请求
        response.setHeader("Access-Control-Allow-Origin", "*");
        if (curPage == null || curPage <= 0){
            curPage = 0;
        ...
        return studentService.findByPageAndSort1(curPage, pageSize);
    }
     ...
     * @return
     */
    @RequestMapping("/findByPageAndSortAndMh")
    @ResponseBody
    public Page<Student> findByPageAndSortAndMh(Integer curPage, Integer pageSize, HttpServletResponse response){
        //解决跨域请求
        response.setHeader("Access-Control-Allow-Origin", "*");
        if (curPage == null || curPage <= 0){
            curPage = 0;
        ...
        return studentService.findByPageAndSortAndMh(curPage, pageSize);
    }
     ...
     * @return
     */
    @RequestMapping("/findByPageAndSortAndMh1")
    @ResponseBody
    public Page<Student> findByPageAndSortAndMh1(Integer curPage, Integer pageSize, HttpServletResponse response){
        //解决跨域请求
        response.setHeader("Access-Control-Allow-Origin", "*");
        if (curPage == null || curPage <= 0){
            curPage = 0;
        ...
        return studentService.findByPageAndSortAndMh1(curPage, pageSize);
    }
