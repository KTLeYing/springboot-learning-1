package com.mzl.rabbitmqdemo6.config;
...
public class RabbitConfig {
    ...
    public DirectExchange mailExchange(){
        return new DirectExchange(MAIL_EXCHANGE_NAME, true, true);
    }

    //绑定队列在交换机上,routing_key代表是某个交换机和某个队列的匹配
    @Bean
