package com.mzl.qrcodedemo1.utils;
...
public class QrCodeUtils {
     ...
     * 生成二维码
     *
     * @param content      二维码内容（输出普通的文字和链接均可，BitMatrix会自动识别链接）
    ...
    /**
     * 生成二维码(内嵌LOGO)（输出普通的文字和链接均可，BitMatrix会自动识别链接）
     *
     * @param content      内容
     * @param logoPath     LOGO地址
     * @param output       输出流
