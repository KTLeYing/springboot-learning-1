package com.mzl.zfbpaydemo2.controller;
...
import com.mzl.zfbpaydemo2.exception.CustomException;
...
public class OrderController {
    ...
    public void alipayReturn(HttpServletRequest request, HttpServletResponse response){
        ...
        try{
            ...
            if (flag){
                ...
                orderInfoService.updateStatus(orderId, status, tradeNo);
                response.setContentType("text/html;charset=utf-8");
        ...
        try{
            ...
            if (flag){
                ...
                switch (tradeStatus){
                     ...
                     */
                    case "WAIT_BUYER_PAY":
                        orderInfoService.updateStatus(orderId, tradeStatus);
                        break;
                    /*
                     * 关闭订单
                     ...
                     */
                    case "TRADE_SUCCESS" :
                        orderInfoService.updateStatus(orderId, tradeStatus, tradeNo);
                        break;
                    default:
                        break;
                }
    ...
    public Result queryOrder(String orderId, String alipayNo) {
        ...
        try {
            ...
            if("10000".equals(code)) {
                ...
                OrderInfo orderInfo = orderInfoService.findById(outTradeNo);
    ...
    public Result refund(String orderId, String alipayNo, float money, String reason) {
        ...
        System.out.println(canRefundMoney);
        ...
        String refundId = RandomUtil.time();
    ...
    private Result closeOrder(String orderId, String alipayNo) {
        ...
        try{
            ...
            if("10000".equals(code)) {
                // 将状态更改为关闭
                String outTradeNo = responseMap.get("out_trade_no");
                orderInfoService.updateStatus(outTradeNo, "TRADE_CLOSED");
                return Result.ok();
            } else {
