package com.mzl.scheduledemo1.sendemail.service.impl;

import com.mzl.scheduledemo1.sendemail.pojo.Mail;
import com.mzl.scheduledemo1.sendemail.result.CodeEnum;
import com.mzl.scheduledemo1.sendemail.result.Result;
import com.mzl.scheduledemo1.sendemail.service.MailService;
import com.mzl.scheduledemo1.sendemail.utils.MailUtils;
...
public class MailServiceImpl implements MailService {
     ...
     */
    @Override
    public void sendCommonEmail(Mail mail) {
        try{
...
//            return new Result(CodeEnum.FAIL.getCode(), CodeEnum.FAIL.getMsg());
     ...
     */
    @Override
    public void sendAttachedEmail(Mail mail, MultipartFile multipartFile) {
        try{
...
//            return new Result(CodeEnum.FAIL.getCode(), CodeEnum.FAIL.getMsg());
     ...
     */
    @Override
    public void sendAttachedEmail1(Mail mail, String file1, String file2) {
        try{
...
//            return new Result(CodeEnum.FAIL.getCode(), CodeEnum.FAIL.getMsg());
     ...
     */
    @Override
    public void sendStaticEmail(Mail mail, MultipartFile multipartFile, String resId) {
        try{
...
//            return new Result(CodeEnum.FAIL.getCode(), CodeEnum.FAIL.getMsg());
     ...
     */
    @Override
    public void sendStaticEmail1(Mail mail, String[] imagePaths, String[] imageId) {
        try{
