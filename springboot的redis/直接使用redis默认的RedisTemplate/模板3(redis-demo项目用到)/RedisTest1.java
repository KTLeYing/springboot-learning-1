...
public class RedisTest1 {
  ...
  public void testStringRedisTemplate() {
        ...
        System.out.println(redisStringTemplate.opsForValue().get("hello"));
    }
    ...
    public void testRedisTemplate() {
        redisTemplate.opsForValue().set("redisTemplate", "");
        System.out.println(redisTemplate.opsForValue().get("ahh"));
    }
