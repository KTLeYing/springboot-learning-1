...
import com.mzl.shirojwtSSO.shiro.jwt.JwtFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean factory(SecurityManager securityManager) {
        ...
        // 所有请求通过我们自己的JWT Filter进行用户身份的认证
...
//        filterRuleMap.put("/webjars/**","anon");
        //放行登录接口和其他不需要权限的接口
        filterRuleMap.put("/user/login", "anon");  //匿名访问即为直接放行请求，不需要认证和授权等处理
